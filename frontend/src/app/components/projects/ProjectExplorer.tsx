...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/rose-doc");
        const movingFolderId = e.dataTransfer.getData("application/rose-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/rose-doc") ||
            Array.from(e.dataTransfer.types).includes("application/rose-folder")
        );
    }
                    ...
                    return (
                        <li key={`f-${folder.id}`}>
                            <div
                                draggable
                                onDragStart={(e) => {
                                    e.dataTransfer.setData("application/rose-folder", folder.id);
                ...
                {childDocs.map((doc) => {
                    ...
                    return (
                        <li
                            ...
                            draggable
                            onDragStart={(e) => {
                                e.dataTransfer.setData("application/rose-doc", doc.id);
                                e.dataTransfer.effectAllowed = "move";
                            }}
